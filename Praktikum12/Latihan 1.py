...
'''Jalur terpendek yang dapat dipilih adalah jalur A -> C -> D, karena total bobot yang dimiliki jalur tersebut adalah yang paling kecil'''
# 4. Mengapa jalur terpendek tidak selalu ditentukan dari jumlah edge yang paling sedikit?
'''Karena jalur terpendek juga ditentukan oleh total bobot masing-masing jalur dan edge memiliki bobot yang berbeda'''